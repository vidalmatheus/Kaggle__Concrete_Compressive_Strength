...
Na definição da gramática, criamos milhares de constantes de ordem de grandezas diferentes e um grupo em especial próximos de “pi”, estas poderão substituir os “<var>”, fazemos vários arrays para se escrever nas derivações dos cromossomos, as repetições nesses arrays são utilizadas para distribuir a probabilidade da expressão se formar, nelas temos expressões básicas, trigonométricas, hiperbólicas e logarítmicas.

<!-- Importa a Imagem -->
![](images/gramatica.PNG)
...
No torneio de cromossomos, nós queremos uma variabilidade alta e um bom controle de qualidade, logo, selecionamos os cromossomos de derivações diferentes e com erro quadrático diferente de infinito, a partir manteremos os 10% melhores para a próxima geração, e todos irão participar de um torneio para serem cruzados e mutados.
...
No cruzamento, nós pegamos o pivô sempre tendo que estar no intervalo dos genes usados pela derivação, assim faz com que o cruzamento altere a derivação, logo o resultado.
...
A mutação não ocorre nos 10% melhores diretamente, mas nas suas copias feitas através do vetor de cromossomos, e ao passar um bloco conjunto de 10% dos cromossomos, onde o primeiro é composto pelos melhores a probabilidade de mudar cada gene irá aumentar, garantindo que os melhores passem por mutações pequenas e grandes.
